...
inline __attribute__((always_inline)) u16		currentKeyState() { return __currKeys; }
inline __attribute__((always_inline)) u16		prevKeyState() { return __prevKeys; }
inline __attribute__((always_inline)) u32		keyDown(u32 a_key) { return __currKeys & a_key; }
inline __attribute__((always_inline)) u32		keyUp(u32 a_key) { return ~__currKeys & a_key; }
inline __attribute__((always_inline)) u32		keyHeld(u32 a_key) { return (__currKeys & __prevKeys) & a_key; }
inline __attribute__((always_inline)) u32		keyReleased(u32 a_key) { return (~__currKeys & __prevKeys) & a_key; }
inline __attribute__((always_inline)) u32		keyHit(u32 a_key) { return (__currKeys & ~__prevKeys) & a_key; }
inline __attribute__((always_inline)) u32		keyStateChange(u32 a_key) { return (__currKeys ^ __prevKeys) & a_key; }
