...
u16 setBG_Control_Register(u8 a_regNum, u8 a_priority, u8 a_tileBlockID, u8 a_mosaic, u8 a_colourMode, u8 a_mapBlockID, u8 a_affineWrap, u8 a_bgSize)
{
...
u16* palette__bg_block_address(u32 a_blockNum)
{
...
u16 SetAttrib2(u8 a_tileIndex, u8 a_priority, u8 a_paletteBank)
{
	u16 attrib2 = (a_tileIndex & 0x3FF) | ((a_paletteBank & 0xF) << 12) | ((a_priority & 3) << 10);
	return attrib2;
}
